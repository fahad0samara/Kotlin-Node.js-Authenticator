...
import com.fahad.kotlinnodeauthenticator.ui.screen.login.LoginViewModel
    ...
    Box(
        ...
        Column(
            ...
            EmailAndPasswordInputs(
              ...
              isError = loginResult?.success == false,
                showNameField = false,
                name = "",
                onNameChange = { },
            )
          ...
          loginResult?.let { DisplayError(it) }

            // Login Button
            LoadingButton(
              text = "Login", isLoading = loginResult?.isLoading ?: false,
